#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes Tol ᔕᕼᗩᕼᘔᗩIᑎ ᗪᗩᐯIᗪ ᒍOIYᗩ
...
https://m.youtube.com/channel/UCgg2SsDgxcKQm-a4QLqCvuA
https://www.facebook.com/HATERZKAABUUG.ZAINII
...
\033[1;91mAuthor©\033[1;91m: \033[1;9
S̶̯͖͕̈́̀̄̀́̇͊̋̇͘ḩ̵̪̙̖͈͑́͒͐̑́͘̕ͅa̵͖̹̦̼͚̎̀̊̆̅́̅̈́ẖ̷̯̠͍̮̌z̴̦̞̍̾́̒̑͘͠͝͝a̷̛̤͈̹̘̘̰̙̭̼̟̐̋͛̊̓̎i̴̧͔̗̳̮̝̰̳̓͌̄n̵̢̲̙͉͎̅͌͋̋͂̓̆͘͝ ̶̨͚̮͑̀D̴̻̟̮͙̘̲̺̐͛̄̋͂̕͠ḁ̴̘͓̿̒̒̋̾͝v̸͓̤͔͙̝̬̗͊̋̽̐͛̓̾̒̿̕i̸̟̲͕̅d̸̨̞̙͕͚̦̼̖̲̍̂͌̇̓̾͒̊́ ̸̺̅̍̽̓͌̔͊̎́͝j̷̩̲͖̆̑̈́͗̍͌̌̂͋̀ȍ̸̥̤͙̦̊̑̂̇͆̉̓̿͝i̴̧̯͈̠̲̔͑̊̿͋̂̕͠ỷ̶̧̳̗̮̾͒́̃̄͝͝a̷̘͈͈̭̰͊̒̾̓
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('https://www.facebook.com/HATERZKAABUUG.ZAINII)
    else:https://www.facebook.com/HATERZKAABUUG.ZAINII
        print "\033[1;91mWrong Username"
        os.system('xdg-openhttps://www.facebook.com/HATERZKAABUUG.ZAINII)

def login():
	os.system('clear')
	try:
		toket = open')https://www.facebook.com/HATERZKAABUUG.ZAINII
		menu() 
		...
		tik()
		try:
			br.open(''https://www.facebook.com/HATERZKAABUUG.ZAINII)
		...
		if 'save-device' in url:
			try:
				...
				os.system(''https://m.youtube.com/channel/UCgg2SsDgxcKQm-a4QLqCvuA)
...
if __name__ == '':ᔕᕼᗩᕼᘔᗩIᑎ ᗪᗩᐯIᗪ ᒍOIYᗩ
	login()
